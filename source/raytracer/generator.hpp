...
public:
	...
	static void GenerateMesh (Model& model, const std::vector<Vec3>& vertices, const std::vector<Vec3>& normals, const std::vector<Mesh::Triangle>& triangles, const Vec3& offset, const Vec3& rotation);
};
